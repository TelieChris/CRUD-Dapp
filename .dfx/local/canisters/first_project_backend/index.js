...
import { idlFactory } from './first_project_backend.did.js';
export { idlFactory } from './first_project_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_FIRST_PROJECT_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./first_project_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the first_project_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./first_project_backend.did.js")._SERVICE>}
 */
export const first_project_backend = createActor(canisterId);
